...
func TestFromEnvDefaults(t *testing.T) {
	...
	if cfg.Port != 4318 || cfg.DataDir != "./data" || cfg.RetentionDays != 30 || cfg.AuthToken != "" || cfg.PricingFile != "" || cfg.AnthropicUpstream != "" || cfg.OpenAIUpstream != "" || cfg.OpenAICompatUpstreams != "" || cfg.ChatGPTUpstream != "" || cfg.GeminiUpstream != "" {
...
func TestFromEnvParsesAllValues(t *testing.T) {
	...
	want := Config{Port: 9000, DataDir: "/tmp/spanbox", RetentionDays: 0, AuthToken: "secret", PricingFile: "/tmp/prices.json", AnthropicUpstream: "http://anthropic.test/base", OpenAIUpstream: "http://openai.test/base", OpenAICompatUpstreams: "local=http://localhost:18080/v1", ChatGPTUpstream: "http://chatgpt.test/base", GeminiUpstream: "http://gemini.test/base"}
	if cfg != want {
